...
void Cycle()
{
	...
	if(t_adc==1)
	{
		...
		P1ASF=0x08;		//p1.3//00001000
		ADC_CONTR=0x8b;	//第P1.3/即1000第四位，3表示为0011，最后一位开启检测1011
	}
	else if(t_adc==2)
	{
		t_adc=0;
		...
		P1ASF=0x00;	  //p1.2//00000100
		ADC_CONTR=0x88;	 //p1.2//0100,2//0010
	}
...
while(1)
{
	...
	{	
		...
		{	
			...
			TX_mode();
			tx[0]=rx_num;
			voltage_bec=1350210/last_adc1;	 // 1299210
			tx[1]=voltage_bec>>8;
			tx[2]=voltage_bec;
